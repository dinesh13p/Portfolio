    ...
    <div className="container h-full flex flex-col" style={{
      ...
      >
        ...
        >
          ...
          <motion.div
            className="mt-3 sm:mt-4 text-sm sm:text-base text-gray-300 leading-relaxed space-y-3"
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
            ...
            <div className="space-y-6 pb-4">
              {skillCategories.map((category, catIndex) => (
                <div key={category.category}>
                  <motion.h4
                    className="text-lg sm:text-xl font-semibold mb-3 text-gray-200"
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: catIndex * 0.1 + 0.5, duration: 0.5 }}
                  >
                    {category.category}
                  </motion.h4>
                      ...
                      return (
                        ...
                        >
                          ...
                          <motion.div
                            ...
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: currentIndex * 0.05 + 0.7 }}
                          >
                            {skill.name}
                          </motion.div>
