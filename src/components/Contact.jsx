      ...
      >
        ...
        >
          <motion.input 
            ...
            className="p-4 bg-site-mid rounded-xl border border-gray-600 focus:border-brand transition-all duration-300 focus:ring-2 focus:ring-brand/20" 
            disabled={loading}
          ...
          <motion.textarea 
            ...
            onChange={handleChange} 
            placeholder="Message" 
            className="p-4 bg-site-mid rounded-xl col-span-1 sm:col-span-2 border border-gray-600 focus:border-brand transition-all duration-300 focus:ring-2 focus:ring-brand/20" 
            rows={6}
            disabled={loading}
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <motion.button 
              type="submit"
              className="px-6 py-4 rounded-2xl btn-primary text-white font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading}
              whileHover={{ 
